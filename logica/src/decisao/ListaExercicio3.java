...
public class ListaExercicio3 {
	...
	public static void main(String[] args) {
		...
		char operador =0;
		char continuar = 0;
		//definir fora da repetição para economizar memoria
		int numero1 = 0;
		int numero2 = 0;
		do{
			...
			do {
				operador = JOptionPane.showInputDialog("Digite um operador válido (<+>, <->, <*>, </>").charAt(0);
			...
			if (operador == '+') {
				...
				System.out.println("O resultado é: " + (float) (numero1 / numero2));
			}
