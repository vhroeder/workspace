...
public class DesafioRepeticao {
	...
	public static void main(String[] args) {
		 ...
		 * ----atualizações----
		 * 1 - o jogador 2 irá receber dicas enquanto ele não acertar
		...
		System.out.println("Parabéns Jogador 2. Você acertou! A resposta é: " + valor1 +"! Você acertou em: " + tentativas + " tentativas!");
	}
}