...
public class Formula1 {
	...
	private int rpm;
	/*
	 * síntaxe para criação de métodos no Java:
	 * <modificador> <tipo do retorno> <nomeDoMetodo> (<tipo do parametro> <nome do parametro>) 
	 */
	
	
	/*
	 * crie um método para preencher tudo - preencherTudo()
	 * crie um método para exibir tudo - exibirTudo()
	 * crie um método para exibir o valor com 10% - exibirPromocao()
	 * crie um método para exibir o valor com desconto a ser recebido por parametro - exibirPromocao()
	 */
